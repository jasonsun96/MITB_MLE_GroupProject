...
def sample_processing_function(bronze_table_path, gold_table_path, spark):
...
gold_table_path = f"{GOLD_PATH}/{GOLD_TABLES['legal_docs_processed']['path']}"
sample_processing_function(bronze_table_path, gold_table_path, spark)
